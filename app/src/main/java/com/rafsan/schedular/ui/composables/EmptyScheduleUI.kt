...
@Composable
fun EmptyScheduleUI(title: String = stringResource(R.string.no_schedules_are_set), subTitle: String = stringResource(R.string.set_a_schedule_to_launch_your_app)) {
    Column(
        modifier = Modifier
            .fillMaxSize(),
